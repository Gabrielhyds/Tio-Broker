...
class ClienteController
{
    ...
    public function cadastrar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $dados = [
                ...
                'foto' => $_POST['foto'] ?? null, // Tratamento de upload de foto será implementado
    ...
    public function mostrar()
    {
        ...
        // Verifica se o ID do cliente foi informado corretamente
    ...
    public function excluir()
    {
        ...
        // Aqui você pode adicionar regras para limitar a exclusão a usuários autorizados
