            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="nome" name="nome" class="form-control"
                    value="<?= htmlspecialchars($dados['nome'], ENT_QUOTES) ?>" required />
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="email" id="email" name="email" class="form-control"
                    value="<?= htmlspecialchars($dados['email'], ENT_QUOTES) ?>" required />
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="cpf" name="cpf" class="form-control"
                    value="<?= htmlspecialchars($dados['cpf'], ENT_QUOTES) ?>" maxlength="14"
                    required onkeypress="apenasNumeros(event)" oninput="formatarCPF(this)" />
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="telefone" name="telefone" class="form-control"
                    value="<?= htmlspecialchars($dados['telefone'], ENT_QUOTES) ?>" maxlength="15"
                    required onkeypress="apenasNumeros(event)" oninput="formatarTelefone(this)" />
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <?php if (!empty($dados['foto'])): ?>
                  <img src="<?= htmlspecialchars($dados['foto'], ENT_QUOTES) ?>" alt="Foto do usuário"
                    width="100" />
                <?php else: ?>
              ...
              <div class="col-md-6">
                ...
                <select id="permissao" name="permissao" class="form-select" required>
                  <option value="Admin" <?= $dados['permissao'] === 'Admin' ? 'selected' : '' ?>>Admin
                  </option>
                  <option value="Coordenador"
                    <?= $dados['permissao'] === 'Coordenador' ? 'selected' : '' ?>>Coordenador
                  </option>
                  <option value="Corretor"
                    <?= $dados['permissao'] === 'Corretor' ? 'selected' : '' ?>>Corretor</option>
                </select>
              </div>

              <!-- Imobiliária -->
              <div class="col-md-6">
                <!-- --- CORRIGIDO --- O 'name' e 'id' foram alterados para 'id_imobiliaria' -->
                <label for="id_imobiliaria" class="form-label">Imobiliária</label>
                <select id="id_imobiliaria" name="id_imobiliaria" class="form-select" required>
