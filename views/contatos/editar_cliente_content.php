...
<style>
    ...
    .image-preview-wrapper { display: none; position: relative; width: 150px; height: 150px; margin: 0 auto; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const fotoExistente = "<?= !empty($cliente['foto']) ?>";
    ...
    // CORREÇÃO: Scripts de máscara restaurados
    ...
    if (form) {
        form.addEventListener('submit', () => {
            // Limpa a máscara dos campos de moeda antes de enviar
            camposDinheiro.forEach(id => {
                const input = document.getElementById(id);
