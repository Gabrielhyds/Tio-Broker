...
<!-- 
  MUDANÇAS:
  1. Adicionado 'h-16' (altura fixa)
  2. Adicionado 'id="header-container"'
  3. Adicionado classes 'dark:'
-->
<header id="header-container" class="h-16 fixed top-0 right-0 lg:left-64 z-30 flex items-center justify-between p-4 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 transition-all duration-300 ease-in-out">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="relative hidden md:block">
            ...
            <input type="text" data-i18n="header.search" placeholder="Buscar..." class="w-64 lg:w-96 pl-10 pr-4 py-2 bg-gray-100 border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400 dark:focus:ring-blue-500 transition">
        </div>
    </div>
    ...
    <div class="flex items-center space-x-4 md:space-x-6">
        ...
        <div class="relative">
            ...
            <div id="notification-menu" class="hidden absolute right-0 mt-3 w-72 md:w-80 bg-white rounded-md shadow-lg py-1 z-20 transition-all duration-200 origin-top-right dark:bg-gray-800 dark:border dark:border-gray-700">
                <div class="px-4 py-3 flex justify-between items-center">
                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-200" data-i18n="header.notifications">Notificações</p>
                ...
                <div id="notification-list" class="max-h-64 overflow-y-auto">
                    <div class="px-4 py-3 text-center text-sm text-gray-500 dark:text-gray-400" data-i18n="header.no_notifications">
                        Nenhuma notificação nova.
                    </div>
                </div>
                <hr class="dark:border-gray-700">
                <a href="<?= BASE_URL ?>views/notificacoes/todas.php" class="block px-4 py-2 text-sm text-center text-blue-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-blue-400" data-i18n="header.all_notifications">
                    Ver todas
                </a>
            </div>
        </div>
        ...
        <div class="relative">
            ...
            <div id="profile-menu" class="hidden absolute right-0 mt-3 w-56 bg-white rounded-md shadow-lg py-1 z-20 transition-all duration-200 origin-top-right dark:bg-gray-800 dark:border dark:border-gray-700">
                <div class="px-4 py-3">
                ...
                <a href="../usuarios/perfil.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-blue-500 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-blue-400" data-i18n="header.profile">Meu Perfil</a>
                <a href="../configuracao/configuracao.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-blue-500 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-blue-400" data-i18n="header.settings">Configurações</a>
                <a id="logout-btn" href="<?= BASE_URL ?>controllers/LogoutController.php" class="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:text-red-500 dark:hover:bg-red-900/30" data-i18n="header.logout">Sair</a>
            </div>
        </div>
...
<div id="logout-overlay" class="hidden fixed inset-0 bg-gray-900 bg-opacity-70 dark:bg-gray-900/80 z-50 flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-xl flex flex-col items-center space-y-4 text-center dark:bg-gray-800">
        ...
        <p class="text-lg font-semibold text-gray-800 dark:text-gray-200" data-i18n="header.logging_out">Encerrando sessão...</p>
        <p class="text-sm text-gray-500 dark:text-gray-400" data-i18n="header.redirecting">Você será redirecionado em breve.</p>
    </div>
</div>