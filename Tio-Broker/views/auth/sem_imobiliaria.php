...
/*
|--------------------------------------------------------------------------
| ARQUIVO: sem_imobiliaria.php (VERSÃO FINAL)
|--------------------------------------------------------------------------
*/
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title data-i18n="noRealty.title">Acesso Bloqueado - Tio Broker CRM</title>
        ...
        <div class="flex w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-700 to-blue-900 p-12 text-white flex-col justify-between relative overflow-hidden opacity-0 animate-fade-in">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="text-3xl font-bold tracking-tight translating" data-i18n="noRealty.mainHeading">Quase lá!</h1>
                    <p class="mt-4 text-blue-200 translating" data-i18n="noRealty.subheading">Seu acesso está pendente de uma última etapa para você começar a aproveitar a plataforma.</p>
                </div>
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center items-center text-center">
                <div class="text-yellow-500 mb-4 opacity-0 animate-fade-in-up" style="animation-delay: 0.1s;"><i class="fas fa-user-lock fa-4x"></i></div>
                <h2 class="text-2xl font-bold text-gray-800 mb-2 opacity-0 animate-fade-in-up translating" style="animation-delay: 0.2s;" data-i18n="noRealty.formTitle">Acesso Pendente</h2>
                <p class="text-gray-600 mb-4 max-w-sm opacity-0 animate-fade-in-up translating" style="animation-delay: 0.3s;" data-i18n="noRealty.instructions1">Parece que seu usuário ainda não foi vinculado a uma imobiliária.</p>
                <p class="text-gray-600 mb-8 max-w-sm opacity-0 animate-fade-in-up translating" style="animation-delay: 0.4s;" data-i18n="noRealty.instructions2">Por favor, entre em contato com o administrador do sistema para solicitar a liberação do seu acesso.</p>
